...
public class VentanaComputadora extends JFrame {
    ...
    public VentanaComputadora(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(255, 255, 106));
        ...
        panel2.setBackground(new Color(137, 152, 236));
        ...
        panel3.setBackground(new Color(245, 137, 196));
        ...
        panel4.setBackground(new Color(141, 239, 221));
