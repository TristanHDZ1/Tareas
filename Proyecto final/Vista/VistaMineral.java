...
public class VistaMineral extends JFrame {
    ...
    private JTextField txtNombreMineral;
    ...
    private JPanel panel1;//Info
    private JPanel panel2;//Tabla
    private JPanel panel3;//Imagen
    private JPanel panel4;//Update-Delete
    ...
    public VistaMineral(String title) throws HeadlessException {
        ...
        txtNombreMineral =  new JTextField(15);
        ...
        lblRealizarCambios = new JLabel("Realizar cambios,Seleccione un renglon de la tabla");
    ...
    public JTextField getTxtNombreMineral() {
        return txtNombreMineral;
    }

    public void setTxtNombreMinreal(JTextField txtNombreMinreal) {
        this.txtNombreMineral = txtNombreMineral;
    }
    ...
    public void setLblFoto(JLabel Foto) {
        this.Foto = Foto;
    }
    ...
    public void setTxtNombreMineral(JTextField txtNombreMineral) {
        this.txtNombreMineral = txtNombreMineral;
    }
    public void limpiar() {
        txtNombreMineral.setText("");
        txtDureza.setText("");
